...
✅ Tech stack: **PHP + SQL + Vanilla JS + HTML + CSS**
...
### 5.1 Login
- Photographer logs into the desktop application using Fotobook credentials.
- After login:
...
Create docker compose and dockerfiles for web app and for the desktop app if possible.
